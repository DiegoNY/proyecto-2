 ...
 */
$consultaClientes = $bd->query("SELECT e.nombre,e.direccion,e.razon_social,e.ruc,e.celular_contacto from empresa as e where e.eliminada = 1 and e.estado = 1;");

$consultaPosiblesCli = $bd->query("SELECT  e.nombre,e.direccion,e.razon_social,e.ruc,e.celular_contacto from empresa as e where e.eliminada = 1 and e.estado = 0;"); 

$consultaTodasEmpresas = $bd->query("SELECT e.nombre,e.direccion,e.razon_social,e.ruc,e.celular_contacto from empresa as e where e.eliminada = 1");
/**
